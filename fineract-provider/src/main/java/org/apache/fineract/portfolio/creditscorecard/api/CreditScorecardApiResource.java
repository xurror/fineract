...
public class CreditScorecardApiResource {
    ...
    private final CreditScorecardFeatureRepositoryWrapper featureRepository;
    private final DefaultToApiJsonSerializer<CreditScorecardFeatureData> toApiJsonSerializer;
    private final ApiRequestParameterHelper apiRequestParameterHelper;
    private final PortfolioCommandSourceWritePlatformService commandsSourceWritePlatformService;

    @Autowired
    public CreditScorecardApiResource(final PlatformSecurityContext context, final CreditScorecardReadPlatformService readPlatformService,
            final CreditScorecardFeatureRepositoryWrapper featureRepository,
    ...
    public String retrieveAllScoringFeatures(@Context final UriInfo uriInfo) {
        ...
        final Collection<CreditScorecardFeatureData> scoringFeatures = this.featureRepository.findAllWithNotFoundDetection().stream()
    ...
    public String retrieveScoringFeature(@PathParam("featureId") @Parameter(description = "featureId") final Long featureId,
        ...
        CreditScorecardFeatureData scorecardFeature = this.featureRepository.findOneWithNotFoundDetection(featureId).toData();
        if (settings.isTemplate()) {
            final CreditScorecardFeatureData templateData = this.readPlatformService.retrieveNewScorecardFeatureDetails();
    ...
    public String retrieveNewScorecardFeatureDetails(@Context final UriInfo uriInfo) {
        ...
        final CreditScorecardFeatureData scorecardFeature = this.readPlatformService.retrieveNewScorecardFeatureDetails();
