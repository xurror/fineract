...
@Embeddable
public class LoanScorecardFields implements Serializable {
    ...
    public LoanScorecardFields() {

    }

    public LoanScorecardFields(Integer age, String sex, String job, String housing, BigDecimal creditAmount, Integer duration,
            String purpose) {
        this.age = age;
        this.sex = sex;
        this.job = job;
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof LoanScorecardFields)) return false;
        LoanScorecardFields that = (LoanScorecardFields) o;
