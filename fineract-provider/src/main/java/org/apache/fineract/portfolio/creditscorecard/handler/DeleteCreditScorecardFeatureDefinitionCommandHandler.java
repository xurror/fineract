...
public class DeleteCreditScorecardFeatureDefinitionCommandHandler implements NewCommandSourceHandler {
    ...
    @Autowired
    public DeleteCreditScorecardFeatureDefinitionCommandHandler(final CreditScorecardWritePlatformService writePlatformService) {
    ...
    public CommandProcessingResult processCommand(final JsonCommand command) {
        ...
        return this.writePlatformService.deleteScoringFeature(command.entityId());
    }
}
