...
public class UpdateCreditScorecardFeatureDefinitionCommandHandler implements NewCommandSourceHandler {
    ...
    private final CreditScorecardWritePlatformService writePlatformService;

    @Autowired
    public UpdateCreditScorecardFeatureDefinitionCommandHandler(final CreditScorecardWritePlatformService writePlatformService) {
    ...
    public CommandProcessingResult processCommand(final JsonCommand command) {
        ...
        return this.writePlatformService.updateScoringFeature(command.entityId(), command);
    }
}
