...
public class CreditScorecardApiResourceSwagger {
    ...
    public static final class PutScorecardFeaturesFeatureIdResponse {
        ...
        @Schema(example = "1")
        public Integer resourceId;
        public CreditScorecardApiResourceSwagger.PutScorecardFeaturesFeatureIdResponse changes;
    }
    ...
    public static final class GetScorecardFeaturesTemplateResponse {
        ...
        public Set<CreditScorecardApiResourceSwagger.GetScorecardFeatureResponse.GetScorecardFeatureValueTypeResponse> valueTypeOptions;
        public Set<CreditScorecardApiResourceSwagger.GetScorecardFeatureResponse.GetScorecardFeatureDataTypeResponse> dataTypeOptions;
        public Set<CreditScorecardApiResourceSwagger.GetScorecardFeatureResponse.GetScorecardFeatureCategoryResponse> categoryOptions;
    }
}
