...
public class CreateCreditScorecardFeatureDefinitionCommandHandler implements NewCommandSourceHandler {
    ...
    @Autowired
    public CreateCreditScorecardFeatureDefinitionCommandHandler(final CreditScorecardWritePlatformService writePlatformService) {
    ...
    public CommandProcessingResult processCommand(final JsonCommand command) {
        ...
        return this.writePlatformService.createScoringFeature(command);
    }
}
